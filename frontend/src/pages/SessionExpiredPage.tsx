  ...
  return (
    <div className="error-page">
      <div className="error-container">
        ...
        <p className="error-message">{t('error.sessionExpiredMessage')}</p>
        <p className="error-redirect">{t('error.redirecting')}</p>
        <button className="error-button" onClick={() => navigate('/auth/login')}>
          {t('common.login')}
        </button>
      </div>
    </div>
